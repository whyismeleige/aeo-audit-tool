...
competitor_mentions_table = Table(
    "competitor_mentions",
    metadata,
    ...
    Column("competitor_name_snapshot", Text, nullable=False),
    ...
    Index("ix_competitor_mentions_organization_id", "organization_id"),
    Index("ix_competitor_mentions_project_id", "project_id"),
    Index("ix_competitor_mentions_run_batch_id", "run_batch_id"),
    Index("ix_competitor_mentions_prompt_run_id", "prompt_run_id"),
    Index("ix_competitor_mentions_observation_id", "observation_id"),
    Index("ix_competitor_mentions_extraction_result_id", "extraction_result_id"),
    Index("ix_competitor_mentions_prompt_id", "prompt_id"),
    Index("ix_competitor_mentions_platform_id", "platform_id"),
    Index("ix_competitor_mentions_competitor_id", "competitor_id"),
    Index("ix_competitor_mentions_is_recommended", "is_recommended"),
    Index("ix_competitor_mentions_sentiment", "sentiment"),
    Index("ix_competitor_mentions_mention_type", "mention_type"),
)
